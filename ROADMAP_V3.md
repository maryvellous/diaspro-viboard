...
## 📌 Fase 1: Onboarding Google Master & Flow Vivace (In Corso)
...
- [ ] **Step 1: Login Obbligatorio Google Workspace**
...
- [ ] **Step 2: Configurazione SnailBot IA (Multi-Provider)**
...
- [ ] **Sanificazione Visiva Onboarding**
...
## 📌 Fase 2: Redesign Impostazioni (Account Master & Workspace Hub)
...
- [ ] **Card "Account Google Master" in Cima alle Impostazioni**
...
## 📌 Fase 4: Estensione Integrazioni Media & Dev

- [ ] **Pinterest Moodboard View**
...
- [ ] **GitHub Smart Deduplication**
  - Match automatico delle repository locali con quelle remote GitHub per card unificate.

---

## 📌 Fase 5: Audit Visivo, Zero-Emoji & Performance

- [ ] Audit visivo di tutte le schermate: verifica conformità palette ufficiale (`#1e1333`, `#2b1c47`, `#9D85C6`, `#E8D19E`, `#98A78A`, `#A5C4DC`).
- [ ] Controllo 100% Zero-Emoji nell'intero codebase (validazione tramite linter/audit visivo).
- [ ] Ottimizzazione performance animazioni (`will-change`, CSS transitions senza reflow pesante).
- [ ] Test di build Electron finale (`npm run build` ed exit code 0).

---

## 📌 Fase 6: Ricontrollo & Eliminazione Codice Morto (Dead Code Cleanup)
...
- [ ] **Eliminazione Componenti & Handler Deprecati**
...
- [ ] **Audit degli Import e Dipendenze Non Utilizzate**
